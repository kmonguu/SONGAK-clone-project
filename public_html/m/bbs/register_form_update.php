...
if ($w == "") 
{
    ...
    if ($config[cf_email_mb_member]) 
    {
        ...
        ob_start();
        include_once ($g4[bbs_path]."/register_form_update_mail1.php");
    ...
    if ($config[cf_email_mb_super_admin]) 
    {
        ...
        ob_start();
        include_once ($g4[bbs_path]."/register_form_update_mail2.php");
        $content = ob_get_contents();
        ob_end_clean();
...
// 사용자 코드 실행
include_once ("$g4[mpath]/skin/member/$config[cf_member_skin]/register_update.skin.php");
