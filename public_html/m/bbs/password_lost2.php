...
$content .= "<li>임시 패스워드 : <span style='color:#ff3300; font:13px Verdana;'><strong>$change_password</strong></span> &nbsp;&nbsp;<span style='color:gray'>※아래 링크를 클릭하셔야 변경된 패스워드가 적용됩니다.</span></li>";
...
$content .= "</ul>";
$content .= "<hr>";
$content .= "<p style='padding:3px;'><a href='$href' target='_blank' style='color:#CC0000; font-size:19px; font-weight:bold; '>[임시 패스워드로 변경] ◀◁ 이곳을 클릭해주세요!!!</a></p>";
$content .= "<p>";
$content .= "1. <span style='color:red; font-size:16px; font-weight:bold;'>위의 링크를 클릭하십시오.</span> <span style='text-decoration:underline;font-size:15px;'>링크를 클릭하셔야 비밀번호가 위에 표시된 정보로 변경됩니다.</span> 링크가 클릭되지 않는다면 아래 링크를 브라우저의 주소창에 직접 복사해 넣으시기 바랍니다.<br />";
$content .= "&nbsp;&nbsp;&nbsp;<span style='font-size:13px;'>".$href."</span><br/>";
...
mailer($config["cf_title"], $admin[mb_email], $mb[mb_email], $subject, $content, 1);
