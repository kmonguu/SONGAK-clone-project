...
@include_once("$board_skin_mpath/write_comment_update.head.skin.php");
...
// 자동등록방지 검사
//include_once ($g4[bbs_path]."/norobot_check.inc.php");
...
// 사용자 코드 실행
@include_once("$board_skin_mpath/write_comment_update.skin.php");
@include_once("$board_skin_mpath/write_comment_update.tail.skin.php");
