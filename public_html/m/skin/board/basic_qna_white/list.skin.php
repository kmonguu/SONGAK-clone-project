...
<table width="<?=$width?>" align="center" cellpadding="0" cellspacing="0"><tr><td>
    ...
    <!-- <div style="float:left;">
        ...
        <div style="float:right;margin-bottom:10px;">
            <?if($is_admin){?><img src="<?=$board_skin_path?>/img/icon_total.gif" align="absmiddle" border='0'>
   ...
   <!--  <col width="60" /> -->
    ...
    <tr class="bg<?=$bg?>">
       <!--  <td class="num">
		...
		<td class="img" style="padding:5px;" >
			<?if($it[it_name]){?>
				<a href="<?=$href?>#qnalist"><?=get_it_image2($it[it_id], '_s',70,70);?></a>
			<?}else{?>
				&nbsp;
			<?}?>
		</td>
        <td class="subject">
			...
			$listname = "[".$it[it_name]."]".$list[$i][subject];
			$lname = strcut_utf8(strip_tags($listname), 30);
            ...
            if ($list[$i][is_notice])
                ...
                echo "<a href='{$list[$i][href]}'>[".cut_str($it[it_name],20)."] {$list[$i][subject]}</a>";
            else
