...
<div style="clear:both; height:30px;display:none">
    ...
    <? if ($copy_href) { echo "<a href=\"$copy_href\" class='nBtn3' >복사하기</a> "; } ?>
    <? if ($move_href) { echo "<a href=\"$move_href\" class='nBtn3' >이동하기</a> "; } ?>
...
<div style="height:48px;line-height:38px;border-top:0px solid #7d7d7d;border-bottom:2px solid #d6d6d6;">
	...
	<tr>
		<td>
			<div style="margin-top:30px;text-align:center;">
				<iframe width="580" height="400" src="https://www.youtube.com/embed/<?=$view[wr_1]?>" autoplay="true" frameborder="0" allowfullscreen></iframe>
			</div>
		</td>
	</tr>
<?}?>
...
<table border=0 cellpadding=0 cellspacing=0 width=100%>
	<tr>
		<td style="width:60px;height:50px;border-top:1px solid #d6d6d6;text-align:center">
			<img src="<?=$board_skin_path?>/img/up.jpg" border='0' align="absmiddle" <?=$prev[wr_id] ? "onclick='location.href=\"/m/bbs/board.php?bo_table=".$bo_table."&wr_id=".$prev[wr_id]."\"' style='cursor:pointer;' " : ""?> >
		</td>
	...
	<tr>
		<td style="width:60px;height:50px;border-top:1px solid #d6d6d6;text-align:center">
			<img src="<?=$board_skin_path?>/img/down.jpg" border='0' align="absmiddle" <?=$next[wr_id] ? "onclick='location.href=\"/m/bbs/board.php?bo_table=".$bo_table."&wr_id=".$next[wr_id]."\"' style='cursor:pointer;' " : ""?> />
		</td>
