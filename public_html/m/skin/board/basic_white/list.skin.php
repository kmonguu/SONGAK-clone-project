...
.board_list td {height:50px;border-bottom:1px solid #dddddd;color:#6e6e6e;font-size:17px; font-weight:300; }
...
.search_select { 
	width:100px; height:36px; border:1px solid #d8d8d8; position:relative; float:left; font-size:16px; padding:0 5px; background:#; outline:none; box-sizing:border-box; color:#919191;
	-webkit-appearance:none; -moz-appearance:none; appearance:none; 
	background:url('/img/select_arrow.jpg') no-repeat 80px 16px;}
