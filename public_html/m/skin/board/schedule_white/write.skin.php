...
<tr>
    <td class=write_head>시간</td>
    <td style="padding:10px;">
		<input class='ed' style="width:99%;" name=wr_6 id="wr_6" itemname="시간"  value="<?=$write[wr_6]?>">
	</td>
</tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>

<tr>
    <td class=write_head>장소</td>
    <td style="padding:10px;">
		<input class='ed' style="width:99%;" name=wr_7 id="wr_7" itemname="장소"  value="<?=$write[wr_7]?>">
	</td>
</tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
...
<tr>
    ...
    <td style="padding:10px;">
		<input class='ed' style="width:99%;" name=wr_8 id="wr_8" itemname="연락처"  value="<?=$write[wr_8]?>">
	</td>
</tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
...
<?
$day_1 = substr($write[wr_link1],0,4);
$day_2 = substr($write[wr_link1],4,2);
$day_3 = substr($write[wr_link1],6,2);

$this_day = "$day_1-$day_2-$day_3";
?>

<tr>
    <td class=write_head>날짜</td>
    <td style="padding:10px;">
		<input class=ed type=text id="wr_1" name='wr_1' style="width:100px;background:#bcbcbc;" itemname='날짜' value="<?=$this_day?>" readonly >
		<input type='hidden' class='ed' style="width:100px;" name='wr_link1' id="wr_link1" itemname='날짜' value='<?=$write["wr_link1"]?>'>
	</td>
</tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>

<tr>
    <td class=write_head>아이콘</td>
    <td style="padding:10px;">
		<input type="radio" name="wr_3" id="wr_3_0" value="0" <?=!$write["wr_3"] || $write["wr_3"] == "0" ? "checked" : ""?> />
		<label for="wr_3_0"><img src='<?=$board_skin_path?>/img/dia_review.gif' ></label>
		&nbsp;&nbsp;
		<input type="radio" name="wr_3" id="wr_3_1" value="1" <?=$write["wr_3"] == "1" ? "checked" : ""?> />
		<label for="wr_3_1"><img src='<?=$board_skin_path?>/img/dia_memorial.gif' ></label>
		&nbsp;&nbsp;
		<input type="radio" name="wr_3" id="wr_3_2" value="2" <?=$write["wr_3"] == "2" ? "checked" : ""?> />
		<label for="wr_3_2"><img src='<?=$board_skin_path?>/img/dia_schedual.gif' ></label>
		&nbsp;&nbsp;
		<input type="radio" name="wr_3" id="wr_3_3" value="3" <?=$write["wr_3"] == "3" ? "checked" : ""?> />
		<label for="wr_3_3"><img src='<?=$board_skin_path?>/img/dia_diary.gif' ></label>
	</td>
</tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
