...
<tr>
	...
	$write[wr_4] = $write[wr_4]?$write[wr_4]:10;
			for($s=10;$s>-1;$s--){ 
				...
				$star = $s<10?'0'.$s:$s; 
				//$br=""; if($s==4) $br = "<br/>"; 
				echo $br."<div style='display:inline-block; padding:10px 5px;' ><label for='star_s".$s."'><input type='radio' name='wr_4' class=ed value='".$s."' ".$check." style='height:auto;' id='star_s".$s."' /><img style='padding:5px; ' src='".$board_skin_path."/img/star".$star.".gif' alt='$s' border=0 /></label></div>";}?></td>
</tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
...
<tr>
    <td width="100%" align="center" valign="top" style="padding-top:25px;">
        ...
        <a href="/m/shop/item.php?it_id=<?=$item_id ?  $item_id : $write["wr_6"]?>#afterlist" class="nBtn2">상품으로</a>
	</td>
</tr>
</table>
