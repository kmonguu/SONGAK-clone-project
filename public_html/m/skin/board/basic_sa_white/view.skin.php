...
span.nBtn1 { background:#484848; color:#ffffff; padding:10px 8px; font-size:16px; text-decoration:none; display:inline-block; }
span.nBtn2 { background:#727272; color:#ffffff; padding:10px 8px; font-size:16px; text-decoration:none; display:inline-block; }
span.nBtn3 { background:#dddddd; color:#555555; padding:10px 8px; font-size:16px; text-decoration:none; display:inline-block; }
		...
		<table cellpadding="0" cellspacing="0" border="0" style="width:100%;" >
			<tr>
				...
				<td style="padding:3px 0 0 0">
					<a href="/m/shop/item.php?it_id=<?=$view[wr_6]?>">
...
<div style="clear:both; height:30px;display:none">
    ...
    ?>
	<?if($is_has){?>
	<? echo "<a href=\"/m/shop/item.php?it_id={$view[wr_6]}#afterlist\"><span class='nBtn1'>&lt;&lt;&nbsp;상품으로</span></a> "; ?>
	<?}?>
