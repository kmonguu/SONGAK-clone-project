...
<input type=hidden name=od_amount  id="od_amount"   value='<?=$tot_sell_amount?>'>
...
<tr>
    <td bgcolor=#FAFAFA class="od_group" style='padding-left:10px;' colspan="2">
        ...
        <tr>
            <td>이름</td>
            <td><input type=text id=od_name name=od_name value='<?=$member[mb_name]?>' maxlength=20 class=ed style="width:200px;"></td>
        </tr>
        ...
        <tr>
            <td>비밀번호</td>
            <td>
				<input type=password name=od_pwd class=ed maxlength=20 style="width:200px;">
                영문, 숫자 3~20자
			</td>
        </tr>
        <? } ?>
        ...
        <tr style="display:none;">
            <td>전화번호</td>
            <td><input type="text" name=od_tel value='<?=$member[mb_tel]?>' maxlength=20 class=ed style="width:200px;"></td>
        </tr>
        <tr>
            <td>핸드폰</td>
            <td><input type="tel" class="phonenum" name=od_hp value='<?=$member[mb_hp]?>' maxlength=20 class=ed style="width:200px;"></td>
        </tr>
        <tr>
            <td rowspan=2>주 소</td>
            <td style="padding-bottom:0px;" >
            	<div style="float:left;">
	                <input type=text name=od_zip1 maxlength=5 value='<?=$member[mb_zip1]?>' class=ed readonly style="width:90px;">
            	</div>
                <div style="float:left; margin:0 0 0 5px; padding:0 0 0 0;">
	                <a href="javascript:;" onclick="openDaumPostcode('forderform', 'od_zip1', 'od_addr1', 'od_addr2');">
                        <span class="btn1-o" style="padding:5px 14px;" >우편번호확인</span>
                    </a>
	             </div>
            </td>
        </tr>
        <tr>
            <td style="padding-top:2px; line-height:3;">
                <input type=text name=od_addr1 style="width:90%;" maxlength=50 value='<?=$member[mb_addr1]?>' class=ed readonly><br/>
                <input type=text name=od_addr2 style="width:90%; margin-top:5px" placeholder="상세주소" maxlength=50 value='<?=$member[mb_addr2]?>' class=ed>
            </td>
        </tr>
        <tr>
            <td>E-mail</td>
            <td><input type=text name=od_email style="width:90%;" maxlength=100 value='<?=$member[mb_email]?>' class=ed></td>
        </tr>
...
<tr>
    ...
    <td bgcolor=#FAFAFA class="od_group"  style='padding-left:10px' colspan="2">
        ...
        <div class="od_group_title">
            ...
            <label for='same'><b>주문하시는 분과 동일한 경우 체크하세요.</b></label>
        ...
        <tr>
            <td>이름</td>
            <td><input type=text name=od_b_name class=ed maxlength=20 style="width:200px;"></td>
        </tr>
        <tr style="display:none;">
            <td >전화번호</td>
            <td><input type=tel name=od_b_tel class=ed maxlength=20 style="width:200px;"></td>
        </tr>
        <tr>
            <td>핸드폰</td>
            <td><input type=tel class="phonenum" name=od_b_hp class=ed maxlength=20 style="width:200px;"></td>
        </tr>
        <tr>
            <td rowspan=2>주 소</td>
            <td style="padding-bottom:0px;" >
            	<div style="float:left;">
	                <input type=text name=od_b_zip1 maxlength=5 value='' class=ed readonly style="width:90px;">
            	</div>
                <div style="float:left; margin:0 0 0 5px; padding:0 0 0 0;">
        ...
        <tr>
            <td style="padding-top:2px; line-height:3;">
                <input type=text name=od_b_addr1 style="width:90%;" maxlength=50 class=ed readonly><br/>
                <input type=text name=od_b_addr2 style="width:90%; margin-top:5px" placeholder="상세주소" maxlength=50 class=ed >
            </td>
        </tr>
        <tr>
            <td>전하실말씀</td>
            <td><textarea name=od_memo rows=4 style="width:90%;" class=ed></textarea></td>
        </tr>
        </table>
    </td>
</tr>
        ...
        <table cellpadding=3>
            ...
            <tr>
                ...
                <td colspan="">
                    <div>
                            ...
                            <a href="/m/shop/coupon_select.php?on_uid=<?=$s_on_uid?>" class="fancybox fancybox.iframe"><span class="btn1-o">쿠폰함</span></a> 
                    </div>
                </td>
            </tr>
            <?}?>
            ...
            <tr>        
                ...
                <?
                        ...
                        $temp_point = $tot_amount * ($default[de_point_per] / 100); // 적립금 결제 % 적용
                        ...
                        echo " <input type='number' class='ed' id=od_temp_point name=od_temp_point value='0' ".$od_temp_point_style." >원";
        ...
        <tr>
            <td height=50>
                ...
                if ($default[de_bank_use]) {
                    ...
                    echo "
                        <label class='btn_settlecase'>
                            <input type='radio' id=od_settle_bank name='od_settle_case' class='hidden_radio' value='무통장' $checked style='visibility:hidden; margin:0; padding:0;'>
                ...
                if ($default[de_vbank_use]) {
                    $multi_settle++;
                    echo "<label class='btn_settlecase'><input type='radio' id=od_settle_vbank name=od_settle_case class='hidden_radio' value='가상계좌' $checked style='visibility:hidden; margin:0; padding:0;'><i class='fas fa-laptop-code' style=''></i> <label for='od_settle_vbank'>가상계좌</label></label>&nbsp;";
                    $checked = "";
                }
                ...
                if ($default[de_iche_use]) {
                    $multi_settle++;
                    echo "<br/><label class='btn_settlecase'><input type='radio' id=od_settle_iche name=od_settle_case class='hidden_radio' value='계좌이체' $checked style='visibility:hidden; margin:0; padding:0;'><i class='fas fa-laptop' style=''></i> <label for='od_settle_iche'>계좌이체</label></label>&nbsp;";
                    $checked = "";
                }
                ...
                if ($default[de_card_use]) {
                    $multi_settle++;
                    echo "<label class='btn_settlecase'><input type='radio' id=od_settle_card class='hidden_radio' name=od_settle_case value='신용카드' $checked style='visibility:hidden; margin:0; padding:0;'><i class='fas fa-credit-card' style=''></i> <label for='od_settle_card'>신용카드</label></label>&nbsp;";
                    $checked = "";
                }
                ...
                if (!$default[de_card_point])
                    echo "<br><br>· '무통장입금' 이외의 결제 수단으로 결제 시 적립급을 적립해드리지 않습니다.";
                ?>
...
<p align=center class="shop_btns" style="margin-top:30px;">
    ...
    <a href="javascript:history.go(-1);"><span class='btnBack'>&nbsp;&nbsp;취 소&nbsp;&nbsp;</span></a>
...
function add_delivery(cnt) {
	...
	$(".multi_delivery_"+cnt).load("./orderform_multi_delivery.php", params, function(){
...
function set_orderform(data) {
    ...
    $("input[name='od_zip1']").val(data["od_zip1"]);
