<?
    ...
    /* ============================================================================== */
	if($default[de_kcp_mid]=="T0000") $test_tf = true;
    $g_conf_home_dir  = $_SERVER[DOCUMENT_ROOT]."/shop/kcp";       // BIN 절대경로 입력 (bin전까지) "/m/shop/plugin/kcp"
    ...
    /* ============================================================================== */
	if($test_tf) $g_conf_gw_url    = "testpaygw.kcp.co.kr";
    ...
    /* ============================================================================== */
    if($test_tf) $g_conf_js_url    = "https://pay.kcp.co.kr/plugin/payplus_test_un.js";
	else $g_conf_js_url    = "https://pay.kcp.co.kr/plugin/payplus_un.js";
    ...
    /* ============================================================================== */
    if($test_tf) $g_wsdl           = "KCPPaymentService.wsdl";
    ...
    /* ============================================================================== */
    if($test_tf) $g_conf_site_name = "테스트결제";
	else $g_conf_site_name = $default[de_admin_company_name];
