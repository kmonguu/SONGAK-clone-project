<style type="text/css">
.utilization .style3 p { line-height:26px; margin-bottom:17px; font-size:16px; color:#404040; }

.utilization .bold_font { font-size:16px; font-weight:bold; display:inline-block; margin-bottom:10px; }
.utilization .bold_font2 { font-weight:bold; }

.utilization ol { margin:0 0 -16px 0; padding:0 0 0 30px; }
.utilization ol li { line-height:26px; }
</style>
<div class="ShopCover">
	<table width="100%" cellspacing="0px" cellpadding="0" class="utilization" style="margin:0 auto; >
		<tr>
			<td class="style3">
				<p><font class="bold_font">제1조(목적)</font><br />
				이 약관은 <font style="font-weight:bold;"><?=$config["cf_title"];?></font>(전자상거래 사업자)가 운영하는 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br />
				※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」<br />
				</p>
				
				<p><font class="bold_font">제2조(정의)</font><br />
				①“몰”이란 <font style="font-weight:bold;"><?=$config["cf_title"];?></font>가 재화 또는 용역(이하 “재화등”이라 함)를 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br />
				...
				<p><font class="bold_font">제3조 (약관등의 명시와 설명 및 개정) </font><br />
				① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 사이버 몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.<br />
				② “몰”은 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는 내용 중 청약철회·배송책임·환불조건 등과 같은 중요한 내용을 이용자가 이해할 수 있도록 별도의 연결화면 또는 팝업화면등을 제공하여 이용자의 확인을 구하여야 합니다.<br />
				③ “몰”은 전자상거래등에서의소비자보호에관한법률, 약관의규제에관한법률, 전자거래기본법, 전자서명법, 정보통신망이용촉진 등에 관한법률, 방문판매 등에 관한법률, 소비자 보호법 등 관련법을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.<br />
				...
				⑥ 이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 전자상거래등에서의소비자보호에관한법률, 약관의규제등에관한법률, 공정거래위원회가 정하는 전자상거래 등 에서의소비자보호지침 및 관계법령 또는 상관례에 따릅니다.<br />
				</p>
				
				<p style="margin-bottom:0px;"><font class="bold_font">제4조(서비스의 제공 및 변경)</font><br />
				...
				③ “몰”이 제공하기로 이용자와 계약을 체결한 서비스의 내용을 재화등의 품절 또는 기술적 사양의 변경 등의 사유로 변경할 경우에는 그 사유를 이용자에 통지 가능한 주소로 즉시 통지합니다.<br />
				④ 전항의 경우 “몰”은 이로 인하여 이용자가 입은 손해를 배상합니다. 다만, “몰”이 고의 또는 과실이 없음을 입증하는 경우에는 그러하지 아니합니다.<br />
				</p>
				
				<p><font class="bold_font">제5조(서비스의 중단)</font><br />
				① “몰”은 컴퓨터 등 정보통신설비의 보수점검ㆍ교체 및 고장, 통신의 두절 등의 사유가 발생한 경우에는 서비스의 제공을 일시적으로 중단 할 수 있습니다.<br />
				...
				<p style="margin-bottom:0px;"><font class="bold_font">제6조(회원가입)</font><br />
				...
				<p style="margin-bottom:0px;"><font class="bold_font">제7조(회원 탈퇴 및 자격 상실 등) </font><br />
				...
				<p><font class="bold_font">제8조(회원에 대한 통지)</font>  <br />
				...
				<p><font class="bold_font">제9조(구매신청)</font> <br />
				...
				<p style="margin-bottom:0px;"><font class="bold_font">제10조 (계약의 성립)</font><br />
				...
				③ “몰”의 승낙의 의사표시에는 이용자의 구매 신청에 대한 확인 및 판매가능 여부, 구매신청의 정정 취소등에 관한 정보등을 포함하여야합니다.<br />
				</p>

				<p><font class="bold_font">제11조(지급방법)</font> <br />
				...
				<p><font class="bold_font">제12조(수신확인통지·구매신청 변경 및 취소)</font>  <br />
				...
				다만 이미 대금을 지불한 경우에는 제15조의 청약철회 등에 관한 규정에 따릅니다.<br />
				</p>
				
				<p><font class="bold_font">제13조(재화등의 공급)</font>  <br />
				① “몰”은 이용자와 재화등의 공급시기에 관하여 별도의 약정이 없는 이상, 이용자가 청약을 한 날부터 7일 이내에 재화 등을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. <br />
				다만, “몰”이 이미 재화 등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부 또는 일부를 받은 날부터 2영업일 이내에 조치를 취합니다. 이때 “몰”은 이용자가 재화등의 공급 절차 및 진행 사항을 확인할 수 있도록 적절한 조치를 합니다.<br />
				② “몰”은 이용자가 구매한 재화에 대해 배송수단, 수단별 배송비용 부담자, 수단별 배송기간 등을 명시합니다. 만약 “몰”이 약정 배송기간을 초과한 경우에는 그로 인한 이용자의 손해를 배상하여야 합니다. <br />
				다만 “몰”이 고의·과실이 없음을 입증한 경우에는 그러하지 아니합니다.<br />
				</p>
				
				<p><font class="bold_font">제14조(환급) </font>  <br />
				...
				<p style="margin-bottom:0px;"><font class="bold_font">제15조(청약철회 등)</font><br />
				...
				<p><font class="bold_font">제16조(청약철회 등의 효과)</font>  <br />
				...
				③ 청약철회등의 경우 공급받은 재화등의 반환에 필요한 비용은 이용자가 부담합니다. “몰”은 이용자에게 청약철회등을 이유로 위약금 또는 손해배상을 청구하지 않습니다.<br />
				...
				<p style="margin-bottom:0px;"><font class="bold_font">제17조(개인정보보호)</font><br />
				...
				<p>
				④ “몰”이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보관리 책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공 관련사항(제공받은자, 제공목적 및 제공할 정보의 내용) 등 정보통신망이용촉진 등에관한법률 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.<br />
				...
				<p><font class="bold_font">제18조(“몰“의 의무)</font>  <br />
				...
				③ “몰”이 상품이나 용역에 대하여 「표시·광고의공정화에관한법률」 제3조 소정의 부당한 표시·광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을집니다.<br />
				④ “몰”은 이용자가 원하지 않는 영리목적의 광고성 전자우편을 발송하지 않습니다.<br />
				</p>
				
				<p><font class="bold_font">제19조(회원의 ID 및 비밀번호에 대한 의무)</font>  <br />
				...
				<p style="margin-bottom:0px;"><font class="bold_font">제20조(이용자의 의무) 이용자는 다음 행위를 하여서는 안됩니다.</font><br />
					<ol>
				...
				<p><font class="bold_font">제21조(연결“몰”과 피연결“몰” 간의 관계)</font>  <br />
				...
				<p><font class="bold_font">제22조(저작권의 귀속 및 이용제한)</font>  <br />
				① “몰”이 작성한 저작물에 대한 저작권 기타 지적재산권은 “몰”에 귀속합니다.<br />
				② 이용자는 “몰”을 이용함으로써 얻은 정보 중 “몰”에게 지적재산권이 귀속된 정보를 “몰”의 사전 승낙없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제 3자에게 이용하게 하여서는 안됩니다.<br />
				③ “몰”은 약정에 따라 이용자에게 귀속된 저작권을 사용하는 경우 당해 이용자에게 통보하여야 합니다.<br />
				</p>
				
				<p><font class="bold_font">제23조(분쟁해결)</font>  <br />
				...
				<p><font class="bold_font">제24조(재판권 및 준거법)</font>  <br />
