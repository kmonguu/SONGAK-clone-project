...
var UploadImagePath = "";
var ShowThumbnailSize = { width: 90, height: 70 };
var oEditor = null;
var button;

var imageResizeWidth = 0;
var makeThumbnail = true;
var makeThumbnailWidth = 90;
var makeThumbnailHeight = 70;
var browser = null;
...
// ----------------------------------------------------------------------------------
	...
	btn.style.right = '0px'; //(makeThumbnailWidth - parseInt(btn.style.width, 10) - 1) + 'px';
	btn.style.top = '-1px';
	...
	btn.onmousedown = function() {
        ...
        oEditor.removeEvent(self, 'mousedown', showDelete);
	};
    setImageInfo(self.id);
}
...
function imgComplete(img, imgSize, boxId) {
    ...
    oEditor.addEvent(elem, 'mousedown', showDelete);
...
function showUploadWindow() {
	...
	top.$(".cheditor-popup-window").css({width:"600px", left:"20px"});
	top.$("iframe[name='image.html5.mobile.html']").css("width", "580px");
// ----------------------------------------------------------------------------------
  	var uploadWindow  = document.getElementById("uploadWindow");
  	var uploadWindowWidth  = 580;
  	var winWidth;
...
function removeImages() {
    ...
    for (i=0; i<images.length; i++) {
        ...
        if (img.firstChild !== null) {
            oEditor.removeEvent(img, 'mousedown', showDelete);
