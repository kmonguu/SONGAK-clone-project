...
$g4[title] = $member[mb_nick] . "님의 적립금 내역";
        ...
        <tr> 
            <td width="540" bgcolor="#FFFFFF">
                ...
                <tr bgcolor=#E1E1E1 align=center> 
                    ...
                    <td width=""><b>내용</b></td>
                    <td width="70"><b>지급적립금</b></td>
                    <td width="70"><b>사용적립금</b></td>
                </tr>
...
<tr>
    <td height="30" align="center" bgcolor="#F6F6F6">
        <img src='<?=$g4[bbs_img_path]?>/icon_02.gif'> 보유 적립금 : <B><?=number_format($member[mb_point])?> 점</B></td>
</tr>
<tr> 
	...
	<tr>
		<td>
			<table width='100%' cellpadding=0 cellspacing=0 bgcolor=#F9F9F9>
				<tr>
					<td height=50>&nbsp;&nbsp;&nbsp;<B>내 적립금 </B></td>
					<td><img src='<?=$g4[bbs_img_path]?>/icon_02.gif'> 보유 적립금 : <B><?=number_format($member[mb_point])?></B></td>
				</tr>
			</table>
		</td>
	</tr>
