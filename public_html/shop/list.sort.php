...
<tr>
    ...
    <td width=50% align=right style='padding-top:3px; padding-bottom:3px;'>
        <select id=it_sort name=sort style="font-size:11px;" onchange="if (this.value=='') return; document.location = '<? echo "$_SERVER[PHP_SELF]?ca_id=$ca_id&skin=$skin&ev_id=$ev_id&sort=" ?>'+this.value;" class=small>
            <option value=''>출력 순서
            <option value=''>---------
