...
.checkpop_css2 { display:none; position:fixed; left:50%; margin-left:-200px; top:25%; text-align:left; padding-left:20px; padding-top:30px; font-size:17px; color:#000; width:400px;background-color:white;border-radius:5px;z-index:9999; box-shadow:#444444 3px 3px 3px; padding-bottom:80px; }
.checkpop_css3 { position:absolute; bottom:0px; left:0px; height:40px; text-align:center; font-size:20px; padding-top:8px; width:100%; background-color:#ea4417; color:#fff; cursor:pointer; border-bottom-right-radius:5px; border-bottom-left-radius:5px }
</style>
...
<p align=center class="shop_btns" style="margin-top:30px;" >   
    ...
    <span id='id_saving' class="label_gray" style='display:none;'>
        주문서를 저장 중입니다. 잠시만 기다려 주십시오.
    </span>
</p>
