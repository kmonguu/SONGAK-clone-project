...
<tr>
    <td bgcolor=#FAFAFA class="od_group" style='padding-left:10px;' colspan="2">
        ...
        <tr style="display:none;">
            <td>전화번호</td>
            <td><input type="text" name=od_tel value='<?=$member[mb_tel]?>' maxlength=13 class=ed></td>
        </tr>
        <tr>
            <td>핸드폰</td>
            <td><input type=text class="phonenum" name=od_hp value='<?=$member[mb_hp]?>' maxlength=13 class=ed></td>
        </tr>
        <tr>
            <td rowspan=2>주 소</td>
            <td>
...
<tr>
    ...
    <td bgcolor=#FAFAFA class="od_group"  style='padding-left:10px' colspan="2">
        ...
        <div class="od_group_title">
            ...
            <label for='same' class="checkbox-inline" style="cursor:pointer; font-size:13px;">
                &nbsp;
                <input type=checkbox id=same name=same onclick="javascript:gumae2baesong(document.forderform);" style="margin-top:3px">
...
<?if($is_member && ( $config[cf_use_point] || $default[de_use_coupon])) {?>
    ...
    <tr>
        ...
        <td bgcolor=#FAFAFA class="od_group"  style='padding-left:10px' colspan="2">
            ...
            <div class="od_group_title">
                <i class="fas fa-coins"></i> 적립금<?if($default[de_use_coupon]){?> / 쿠폰<?}?>
            </div>
...
var first_loading_add_delivery = false;
function add_delivery(cnt) {
	...
	$(".multi_delivery_"+cnt).load("./orderform_multi_delivery.php", params, function(){
        ...
        first_loading_add_delivery = true;
	});
...
$(function(){
    ...
    $.post("./_ajax_get_ss_orderform.php", null, function(data){
