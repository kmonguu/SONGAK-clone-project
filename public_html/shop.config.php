...
define(_MISU_QUERY_, "
    ...
    (a.od_receipt_bank + a.od_receipt_card + a.od_receipt_point + a.od_coupon) as receiptamount, /* 입금합계 */
...
$g4[yc4_cardpg][kspay]      = "http://pgims.ksnet.co.kr"; // ksnet
...
//상품후기 테이블
$g4["yc4_after_bo_table"] = "after";
//상품문의 테이블
$g4["yc4_qna_bo_table"] = "qa";



//배송시작 후 자동완료 일
$g4["cf_auto_delivery_complete_day"] = 7;
//------------------------------------------------------------------------------
// 쇼핑몰 변수 모음 끝
//------------------------------------------------------------------------------
?>