...
<tr align=center class='bgcol1 bold col1 ht center'>
    ...
    <td>결제수단</td>
    <td>오프라인</td>
    <td><span class="bbtn1" onclick="location.href='./order_offline.php';">+ 오프라인 주문 추가</span></td>
</tr>
...
if ($i == 0)
    echo "<tr><td colspan=13 align=center height=100 bgcolor='#FFFFFF'><span class=point>자료가 한건도 없습니다.</span></td></tr>\n";
?>
</form>
