...
<table cellpadding=0 cellspacing=0 width=100% class="list02" style="margin:0 0 20px 0;">
...
<tr class=ht>
    <td height=28 class="head">분류코드</td>
    <td colspan=3>
...
<tr class=ht>
    ...
    <td colspan=3>
        ...
        <?=help("기본으로 제공하는 스킨은 $cart_dir/list.skin.*.php 입니다.\n\n$g4[shop_url]/list.php&skin=userskin.php 처럼 직접 만든 스킨을 사용할 수도 있습니다.");?>
    </td>
</tr>
<tr class=ht>
    <td class="head">출력이미지 폭</td>
    <td>
...
<p>
<?=subtitle("선택 입력")?>
<table cellpadding=0 cellspacing=0 width=100%  class="list02">
<colgroup width=15%>
...
<tr class=ht>
    <td class="head">상단 내용 <?=help("상품리스트 페이지 상단에 출력하는 HTML 내용입니다.", -150);?> </td>
    <td colspan=3 align=right><br /><?=cheditor2('ca_head_html', $ca[ca_head_html]);?></td>
</tr>
<tr class=ht>
    <td class="head">하단 내용 <?=help("상품리스트 페이지 하단에 출력하는 HTML 내용입니다.", -150);?></td>
