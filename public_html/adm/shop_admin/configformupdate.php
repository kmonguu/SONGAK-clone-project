...
$sql = " update $g4[yc4_default_table]
            set de_admin_company_owner      = '$de_admin_company_owner',
                ...
                de_xonda_smskey             = '$de_xonda_smskey'
                    , de_npay_use                     = '$de_npay_use'
                    , de_npay_istest                    = '$de_npay_istest'
                    , de_npay_testid                   = '$de_npay_testid'
                    , de_npay_shopid                = '$de_npay_shopid'
                    , de_npay_sitekey               = '$de_npay_sitekey'
                    , de_npay_btnkey                = '$de_npay_btnkey'
                    , de_npay_cmnkey                = '$de_npay_cmnkey'
                    , de_use_multi_delivery         = '$de_use_multi_delivery'
                    , de_use_coupon                     = '$de_use_coupon'
                ";
if ($de_icode_pw)
