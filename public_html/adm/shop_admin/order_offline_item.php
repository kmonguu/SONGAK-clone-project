...
.vright_con_title { font-weight:bold; text-align:left; font-size:16px; color:#414141; width:400px !important; }
...
<form name=fitem id="fitem" method=post  action="./cartupdate.php" style="position:relative; width:100%; display:inline-block; margin-top:10px;">
...
<script>
		...
		function make_options(){
			...
			if($("#io_type1").size() == 0) { //옵션이 없는 상품
				$.post("<?=$g4[shop_path]?>/item_option_make.php", {it_id:it_id, od_sdate:od_sdate, od_edate:od_edate}, function(data){
					$(".optlist").append(data);
				});
				return;
			}
			...
			$.post("<?=$g4[shop_path]?>/item_option_make.php", {it_id:it_id, od_sdate:od_sdate, od_edate:od_edate, type1:type1, type2:type2, type3:type3}, function(data){
					$(".optlist").append(data);
					amount_change();
			});
		}
