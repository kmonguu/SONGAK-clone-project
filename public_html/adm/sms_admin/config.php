...
<table cellpadding=0 cellspacing=0 width=100% border=0 class="list02">
<colgroup width=20%></colgroup>
<colgroup width=80% bgcolor=#FFFFFF></colgroup>


<tr class=ht>
	<td class="head">아이코드 서비스 신청</td>
...
<tr class=ht>
	<td class="head">아이코드 토큰키</td>
	<td>
		<input type=text name=cf_token class=ed value='<?=$sms4[cf_token]?>' required itemname='아이코드 토큰키' style="width:250px;">
		<?=help("아이코드에서 사용하시는 토큰키 입력합니다.")?>
</tr>


<tr class=ht>
	<td class="head">아이코드 토큰키 관리</td>
	<td><a href='https://www.icodekorea.com/?ctl=user_token' target=_blank>http://icodekorea.com/?ctl=user_token</a></td>
</tr>

<tr class=ht>
	<td class="head">서버IP</td>
	<td>
		<?=$_SERVER["SERVER_ADDR"]?>
		<?=help("토큰키 신규추가시 '고객사 서버IP'부분에 입력해주세요");?>
	</td>
</tr>
...
<tr class=ht>
	<td class="head">건수별 금액</td>
	<td>
		단문 <?=number_format($userinfo[gpay])?> 원.
    </td>
</tr>
<? } ?>
<tr class=ht>
	<td class="head">회신번호</td>
	<td>
