...
<tr>
    <td width=25% valign=top align=center>
        <div style="width:238px; height:500px; background-color:#efefef; text-align:center; padding-top:10px;">

        <div style="margin:auto; width:222px; background-color:#F8F8F8; border:1px solid #ccc; text-align:center; margin-bottom:5px;">
        <div style="margin:auto; width:220px; height:210px; margin-top:8px;">
            <textarea name='wr_message' id='wr_message' class=ed style="font-family:굴림체; color:#000; line-height:15px;margin:auto; margin-top:20px; overflow: hidden; width:200px; height:188px; font-size: 9pt; border:0; background-color:#88C8F8;" cols="16" onkeyup="byte_check('wr_message', 'sms_bytes');" accesskey="m" itemname='메세지'></textarea>
        </div>
    ...
    <td width=50% valign=top style="line-height:25px;">
        ...
        <div style="clear:both; height:26px; width:404px;">
