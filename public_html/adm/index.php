...
<div style="width:1000px;"><?=subtitle("신규가입회원 {$new_member_rows}건", "./member_list.php");?></div>
...
<table width=100% cellpadding=0 cellspacing=0 class="list" style="width:1000px;">
...
<br><br>
<div style="width:1000px;"><?=subtitle("최근게시물 {$new_write_rows}건", "$g4[bbs_path]/new.php");?></div>

<table width=100% cellpadding=0 cellspacing=1 class="list" style="width:1000px;">
<input type=hidden name=sst  value='<?=$sst?>'>
<input type=hidden name=sod  value='<?=$sod?>'>
<input type=hidden name=sfl  value='<?=$sfl?>'>
<input type=hidden name=stx  value='<?=$stx?>'>
...
<br><br>
<div style="width:1000px;"><?=subtitle("최근포인트 {$new_point_rows}건", "./point_list.php");?></div>
