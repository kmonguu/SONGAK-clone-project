...
$sql = " update $g4[config_table]
            set cf_title                = '$_POST[cf_title]',
				...
				cf_keyword					= '$_POST[cf_keyword]',
				cf_description				=  '$_POST[cf_description]',
                cf_naver_verification      = '$_POST[cf_naver_verification]',
                cf_use_https            = '$_POST[cf_use_https]',
                cf_https_port           = '$_POST[cf_https_port]',
                cf_https_domain         = '$_POST[cf_https_domain]',
                cf_kakao_key            = '$_POST[cf_kakao_key]',
                cf_naver_client_id      = '$_POST[cf_naver_client_id]',
                cf_naver_client_secret  = '$_POST[cf_naver_client_secret]',
                cf_facebook_app_id      = '$_POST[cf_facebook_app_id]',
                cf_facebook_app_ver     = '$_POST[cf_facebook_app_ver]',
                cf_use_kakao_id_login = '$_POST[cf_use_kakao_id_login]',
                cf_use_naver_id_login = '$_POST[cf_use_naver_id_login]',
                cf_use_facebook_id_login = '$_POST[cf_use_facebook_id_login]',
                cf_use_naver_log    =    '$_POST[cf_use_naver_log]',
                cf_use_naver_log_reg = '$_POST[cf_use_naver_log_reg]',
                cf_use_naver_log_buy = '$_POST[cf_use_naver_log_buy]',
                cf_use_naver_log_cart = '$_POST[cf_use_naver_log_cart]',
                cf_naver_common_key = '$_POST[cf_naver_common_key]',
