<style type="text/css">
.utilization .style3 p {line-height:22px; margin-bottom:17px; font-size:14px; color:#404040;}

.utilization .bold_font { font-size:14px; font-weight:bold; display:inline-block; margin-bottom:10px; }
.utilization .bold_font2 { font-weight:bold; }

.utilization ol { margin:0 0 -16px 0; padding:0 0 0 30px; }
.utilization ol li { line-height:22px; }
</style>
<div class="ShopCover">
	<table width="100%" cellspacing="10px" cellpadding="0" class="utilization">
		<tr>
			<td class="style3">
				<p><font class="bold_font">제1조(목적)</font><br />
				이 약관은 <font style="font-weight:bold;"><?=$config["cf_title"];?></font>(전자상거래 사업자)이(가) 운영하는 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br />
				※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」<br />
				</p>
				
				<p><font class="bold_font">제2조(정의)</font><br />
				①“몰”이란 <font style="font-weight:bold;"><?=$config["cf_title"];?></font>이(가) 재화 또는 용역(이하 “재화등”이라 함)를 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br />
