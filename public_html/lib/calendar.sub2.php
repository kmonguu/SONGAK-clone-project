...
<div class="Calendarbox_s <?=$uid?> ">
	<div class="Calendartop_s">
		<ul>	
			<li style='width:25px'>
			...
			<li style='width:25px' class="right">
	...
	<div class="Calendercon_s">
		<div class="Calenderconl_s">

			<table class="c1_s" summary="캘린더입니다">
				<colgroup>
					<col />
					<col />
					<col />
	...
	<div class="Cdetail_s">
		<ul>
			<li class="none"></li>
			<li id='noss_<?=$uid?>' class="none2">선택불가</li>
			<li class="select"></li>
			<li id='sssddd_<?=$uid?>'>선택한 일정</li>
		</ul>
	</div>
	<?}?>
</div>
