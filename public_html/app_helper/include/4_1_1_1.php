...
<script>
	...
	function load_list(){
		...
		$.post("<?=$g4["mpath"]?>/include/_ajax_notice_list.php", sch_params, function(data){
	...
	function go_view(no){
		...
		location.href=g4_app_path+"/pages.php?p=4_2_1_1&save_sc="+save_sc+"&save_page="+page+"&wr_id="+no+"<?=$qstr?>";
	}
