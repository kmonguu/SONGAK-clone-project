...
<div class="nbox">
	...
	<div id="divContent" style="float:left;width:85.2%;margin-left:7.396%;margin-top:25px;color:#222222;font-size:23px;padding-bottom:26px;border-bottom:2px solid #e0e0e1;">		
        ...
        <ul style='line-height:2;margin:10px 10px 30px 10px;'>
            ...
            <li><strong>CHECK-IN</strong> <span style="float:right;width:70%;line-height:2;"><?=$view[wr_2]?></span></li>
            <li><strong>CHECK-OUT</strong> <span style="float:right;width:70%;line-height:2;"><?=$view[wr_3]?></span></li>
            <li><strong>ROOM TYPE</strong> <span style="float:right;width:70%;line-height:2;"><?=$view[wr_4]?></span></li>
            <li><strong>ROOMS</strong> <span style="float:right;width:70%;line-height:2;"><?=$view[wr_5]?></span></li>
            <li><strong>인원수</strong> <span style="float:right;width:70%;line-height:2;"> 성인: <?=$view[wr_6]?>명 어린이: <?=$view[wr_7]?>명</span></li>


            <li style='font-size:1.3em;margin-top:15px;'>
                <strong>예약자정보</strong> 
            </li>
            <li><strong>NAME</strong> <span style="float:right;width:70%;line-height:2;"><?=$view[wr_name]?></span></li>
            <li><strong>PHONE</strong> <span style="float:right;width:70%;line-height:2;"><a href="tel:<?=$view[wr_1]?>"><?=$view[wr_1]?></a></span></li>
            <li><strong>E-MAIL</strong> <span style="float:right;width:70%;line-height:2;"><?=$view[wr_email]?></span></li>


            <li style='font-size:1.3em;margin-top:15px;'>
                <strong>투숙자정보</strong> 
            </li>
            <li><strong>NAME</strong> <span style="float:right;width:70%;line-height:2;"><?=$view[wr_8]?></span></li>
            <li><strong>PHONE</strong> <span style="float:right;width:70%;line-height:2;"><a href="tel:<?=$view[wr_9]?>"><?=$view[wr_9]?></a></span></li>
            <li><strong>E-MAIL</strong> <span style="float:right;width:70%;line-height:2;"><?=$view[wr_10]?></span></li>
            <li><strong>E-MAIL 수신</strong> <span style="float:right;width:70%;line-height:2;"><?=$view[wr_11] == "Y" ? "예" : "아니오"?></span></li>
