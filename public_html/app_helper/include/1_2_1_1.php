...
<div class="nbox">
	...
	<div style="float:left;position:relative;width:100%;">
		<div style="position:absolute;top:5%;left:23.5%;width:50%;text-align:center;font-weight:bold;font-size:28px;" class="dial_title_1">TODAY</div>
	...
	<script>
		$(function() {
			...
			$.post("<?=$g4["mpath"]?>/include/_ajax_getMonthData.php", null, function(data){
				...
				for(i = 0; i < 4; i++){
					...
					title = data["title"][i];
					$(".dial"+(i+1)).data("date", data["yymm"][i]);
					...
					$(".dial"+(i+1)).click(function(){
						location.href = g4_app_path + '/pages.php?p=1_2_2_1&date='+$(this).data("date");
					});
				}
