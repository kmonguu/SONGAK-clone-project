...
<div class="nbox">
	...
	<div class="tab">
		<ul>
			...
			<li  onclick="location.href=g4_app_path+'/pages.php?p=1_1_3_1&date=<?=$date?>';">포털</li>
			<li  class="on" onclick="location.href=g4_app_path+'/pages.php?p=1_1_4_1&date=<?=$date?>';">OS</li>
