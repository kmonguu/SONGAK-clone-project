...
<div class="nbox">
	<div class="tab2">
		<ul>
			...
			<li class="on"  onclick="menum('menu01-2')">월별</li>
			<li style="color:#a6a6a6;font-size:20px;">&nbsp;&nbsp;|&nbsp;&nbsp;</li>
	...
	<div class="tab">
		<ul>
			<li  onclick="location.href=g4_app_path+'/pages.php?p=1_2_2_1&date=<?=$date?>';">키워드</li>
			<li  class="on"  onclick="location.href=g4_app_path+'/pages.php?p=1_2_3_1&date=<?=$date?>';">포털</li>
			<li  onclick="location.href=g4_app_path+'/pages.php?p=1_2_4_1&date=<?=$date?>';">OS</li>
			<li  onclick="location.href=g4_app_path+'/pages.php?p=1_2_5_1&date=<?=$date?>';">브라우저</li>
		</ul>
	</div>
