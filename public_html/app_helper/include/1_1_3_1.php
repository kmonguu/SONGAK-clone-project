...
<div class="nbox">
	<div class="tab2">
		<ul>
			<li class="on" onclick="menum('menu01-1')">일별</li>
	...
	<div class="tab">
		<ul>
			<li  onclick="location.href=g4_app_path+'/pages.php?p=1_1_2_1&date=<?=$date?>';">키워드</li>
			<li  class="on"  onclick="location.href=g4_app_path+'/pages.php?p=1_1_3_1&date=<?=$date?>';">포털</li>
			<li  onclick="location.href=g4_app_path+'/pages.php?p=1_1_4_1&date=<?=$date?>';">OS</li>
			<li  onclick="location.href=g4_app_path+'/pages.php?p=1_1_5_1&date=<?=$date?>';">브라우저</li>
		</ul>
	</div>
	...
	<script>
		$(function() {
			...
			$.post("<?=$g4["mpath"]?>/include/_ajax_getPortalData.php", {date:"<?=$date?>"}, function(data){
