	...
	<div style="float:left;width:100%;">
		...
		<div style="position:relative;float:left;width:70.5%;">
             ...
             <ul style='line-height:2;margin:10px 10px 30px 10px;'>
                <li><strong>이름</strong> <span style="float:right;width:70%;line-height:2;"><?=$write[wr_name]?></span></li>
                <li><strong>핸드폰</strong> <span style="float:right;width:70%;line-height:2;"><a href="tel:<?=$write[wr_1]?>"><?=$write[wr_1]?></a></span></li>
                <li><strong>객실선택</strong> <span style="float:right;width:70%;line-height:2;"><?=$write[wr_7]?></span></li>
                <li><strong>숙박기간</strong> <span style="float:right;width:70%;line-height:2;"><?=$write[wr_3]?> <?=$write[wr_2]?></span></li>
                <li><strong>인원수</strong> <span style="float:right;width:70%;line-height:2;"> 성인: <?=$write[wr_5]?>명 소인: <?=$write[wr_6]?>명</span></li>
            </ul>
