...
<?for($idx = 0 ; $idx < 11 ; $idx++) {?>
    <input type="hidden" name="wr_<?=$idx?>" value="<?=$write["wr_".$idx]?>" />
<?}?>
...
<div class="nbox" style="padding-top:0;">
	...
	<div style="float:left;width:100%;">
        ...
        <ul style='line-height:2;margin:10px 10px 30px 10px;'>

            <li style='font-size:1.3em'>
                <strong>투숙정보</strong> 
            </li>
            <li><strong>CHECK-IN</strong> <span style="float:right;width:70%;line-height:2;"><?=$write[wr_2]?></span></li>
            <li><strong>CHECK-OUT</strong> <span style="float:right;width:70%;line-height:2;"><?=$write[wr_3]?></span></li>
            <li><strong>ROOM TYPE</strong> <span style="float:right;width:70%;line-height:2;"><?=$write[wr_4]?></span></li>
            <li><strong>ROOMS</strong> <span style="float:right;width:70%;line-height:2;"><?=$write[wr_5]?></span></li>
            <li><strong>인원수</strong> <span style="float:right;width:70%;line-height:2;"> 성인: <?=$write[wr_6]?>명 어린이: <?=$write[wr_7]?>명</span></li>


            <li style='font-size:1.3em;margin-top:15px;'>
                <strong>예약자정보</strong> 
            </li>
            <li><strong>NAME</strong> <span style="float:right;width:70%;line-height:2;"><?=$write[wr_name]?></span></li>
            <li><strong>PHONE</strong> <span style="float:right;width:70%;line-height:2;"><a href="tel:<?=$write[wr_1]?>"><?=$write[wr_1]?></a></span></li>
            <li><strong>E-MAIL</strong> <span style="float:right;width:70%;line-height:2;"><?=$write[wr_email]?></span></li>


            <li style='font-size:1.3em;margin-top:15px;'>
                <strong>투숙자정보</strong> 
            </li>
            <li><strong>NAME</strong> <span style="float:right;width:70%;line-height:2;"><?=$write[wr_8]?></span></li>
            <li><strong>PHONE</strong> <span style="float:right;width:70%;line-height:2;"><a href="tel:<?=$write[wr_9]?>"><?=$write[wr_9]?></a></span></li>
            <li><strong>E-MAIL</strong> <span style="float:right;width:70%;line-height:2;"><?=$write[wr_10]?></span></li>
            <li><strong>E-MAIL 수신</strong> <span style="float:right;width:70%;line-height:2;"><?=$write[wr_11] == "Y" ? "예" : "아니오"?></span></li>
