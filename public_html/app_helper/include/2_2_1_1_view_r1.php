...
<div class="nbox">
	...
	<div id="divContent" style="float:left;width:85.2%;margin-left:7.396%;margin-top:25px;color:#222222;font-size:23px;padding-bottom:26px;border-bottom:2px solid #e0e0e1;">		
            ...
            <ul style='line-height:2;margin:10px 10px 30px 10px;'>
                ...
                <li>
                    <strong>예약상태</strong> 
                    <span style="float:right;width:70%; line-height:2;">
                        <?
                            switch($view[wr_10])
                            {
                                case "1" :
                ...
                <?}?>
                <li><strong>이름</strong> <span style="float:right;width:70%;line-height:2;"><?=$view[wr_name]?></span></li>
                <li><strong>핸드폰</strong> <span style="float:right;width:70%;line-height:2;"><a href="tel:<?=$view[wr_1]?>"><?=$view[wr_1]?></a></span></li>
                <li><strong>객실선택</strong> <span style="float:right;width:70%;line-height:2;"><?=$view[wr_7]?></span></li>
                <li><strong>숙박기간</strong> <span style="float:right;width:70%;line-height:2;"><?=$view[wr_3]?> <?=$view[wr_2]?></span></li>
                <li><strong>인원수</strong> <span style="float:right;width:70%;line-height:2;"> 성인: <?=$view[wr_5]?>명 소인: <?=$view[wr_6]?>명</span></li>
            </ul>
