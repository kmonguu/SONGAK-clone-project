    ...
    $.fn.ulslide = function(settings) {
        ...
        thisEl.uslStatusbar = function() {		
			...
			function isImageLoaded(img) {
				// 찌 荀諺 櫛岫震 load IE ?崖昌猥 鎖姓銳終 穽設堯茴?
				// 全釣鴨? 櫛增?杖?魏倧妖孺 特釣?城鳥修?complete.
				// 희幽孼猥 櫛增設? Gecko-based 鎖姓銳終.
				if (!img.complete) {
					return false;
				}
				// 屢?張 靭張? ?杖?嚴潗 壓?展孼?禎音午紅 竣迹增循: naturalWidth ?naturalHeight.
				// 絞?菴 尿震牆渾 調傲儼 了翟調蓮杖. 퇸泣 魏愉震檣?余?張 裔藎滄堯葉?
				// 桎 佺?哀飮裝 岫潗 調純?腸誼.
