...
<tr>
    <td><input class="input_txt1" size="15" name="wr_subject" itemname="이름" required="required" placeholder="제목" value="<?=$subject?>" onFocus="this.placeholder=''" style="font-size:21px;height:40px;"></td></tr>
...
<tr>
    ...
    <td>
        ...
        <textarea id="wr_content" name="wr_content" class=tx style='width:99%; word-break:break-all; font-szie:21px;' rows=5 itemname="본문" required
...
<tr>
    <td style='padding:5 0 5 0;'><table id="variableFiles" cellpadding=0 cellspacing=0 style="float:left;"></table><?// print_r2($file); ?>
        ...
        function add_file(delete_code)
        {
            ...
            objCell.innerHTML = "<input type='file' class='file' name='bf_file[]' style='border:1px solid #ddd;' title='파일 용량 <?=$upload_max_filesize?> 이하만 업로드 가능'>";
            if (delete_code)
...
<tr>
    <td width="100%" align="center" valign="top" style="padding-top:30px;">
        <input type=image id="btn_submit" src="<?=$board_skin_path?>/img/btn_write.gif" border=0 accesskey='s' style="vertical-align:top;">&nbsp;
