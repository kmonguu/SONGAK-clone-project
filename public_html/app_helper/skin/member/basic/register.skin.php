...
?>
<div style="width:590px; height:551px; margin:50px auto 0;position:relative;">
	<form name="fregister" method="post" onsubmit="return fregister_submit(this);" autocomplete="off">
		<div style="position:absolute;top:0px;left:0px;">
			<!-- <img src="<?=$member_skin_path?>/img/stipulation.gif" /> --><span style="font-size:22px;font-weight:bold;color:#444444">회원가입약관</span>
		</div>
		<div style="width:562px; position:absolute; top:39px; left:11px;clear:both">
		...
		<div style="position:absolute;top:280px;left:0px;">
			<!-- <img src="<?=$member_skin_path?>/img/privacy.gif" /> --><span style="font-size:22px;font-weight:bold;color:#444444">개인정보처리방침</span>
		</div>
