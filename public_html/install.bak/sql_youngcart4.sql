## 마이에스큐엘 dump 10.11
##
## Host: db.sir.co.kr    Database: yc4
## ######################################################
...
CREATE TABLE `$g4[yc4_cart_table]` (
  ...
  `it_option1` varchar(50) NOT NULL default '',
  `it_option2` varchar(50) NOT NULL default '',
  `it_option3` varchar(50) NOT NULL default '',
  `it_option_amount` INT NOT NULL default 0,
  ...
  `it_coupon` VARCHAR( 255 ) NOT NULL,
  PRIMARY KEY  (`ct_id`),
  KEY `on_uid` (`on_uid`),
  KEY `it_option` ( `it_id`,`ct_status`,`it_option1`,`it_option2`,`it_option3` )
);
...
CREATE TABLE `$g4[yc4_default_table]` (
  ...
  `de_sms_cont1` text NOT NULL default '',
  `de_sms_cont2` text NOT NULL default '',
  `de_sms_cont3` text NOT NULL default '',
  `de_sms_cont4` text NOT NULL default '',
  ...
  `de_sms_hp2` varchar(255) NOT NULL default '',
  ...
  `de_npay_use` INT NOT NULL DEFAULT  '0',
  `de_npay_istest` INT NOT NULL DEFAULT  '1',
  `de_npay_testid` varchar(255) NOT NULL default '',
  `de_npay_shopid` varchar(255) NOT NULL default '',
  `de_npay_sitekey` varchar(255) NOT NULL default '',
  `de_npay_btnkey` varchar(255) NOT NULL default '',
  `de_npay_cmnkey` varchar(255) NOT NULL default '',
  `de_use_multi_delivery` INT NOT NULL,
  `de_use_coupon` INT NOT NULL
);
...
CREATE TABLE `$g4[yc4_item_table]` (
  ...
  `it_option1_subject` VARCHAR( 255 ) NOT NULL default '',
  `it_option1` VARCHAR( 255 ) NOT NULL default '',
  `it_option2_subject` VARCHAR( 255 ) NOT NULL default '',
  `it_option2` VARCHAR( 255 ) NOT NULL default '',
  `it_option3_subject` VARCHAR( 255 ) NOT NULL default '',
  `it_option3` VARCHAR( 255 ) NOT NULL default '',
  ...
  `it_free_send` INT NOT NULL default '0',
  PRIMARY KEY  (`it_id`),
  KEY `ca_id` (`ca_id`),
  KEY `it_name` (`it_name`),
...
CREATE TABLE `$g4[yc4_order_table]` (
  ...
  `od_zip1` varchar(5) NOT NULL default '',
  `od_zip2` varchar(5) NOT NULL default '',
  ...
  `od_b_zip1` varchar(5) NOT NULL default '',
  `od_b_zip2` varchar(5) NOT NULL default '',
  ...
  `od_delivery_cnt` INT NOT NULL,
  `od_is_offline` INT NOT NULL,
  PRIMARY KEY  (`od_id`),
...
DROP TABLE IF EXISTS `yc4_order_del`;

CREATE TABLE IF NOT EXISTS `yc4_order_del` (
  `od_id` varchar(10) NOT NULL default '',
  `on_uid` varchar(32) NOT NULL default '',
  `mb_id` varchar(20) NOT NULL default '',
  `od_pwd` varchar(255) NOT NULL default '',
...
DROP TABLE IF EXISTS `yc4_item_option`;

/** 상품옵션 (옵션별 수량) */
CREATE TABLE IF NOT EXISTS `yc4_item_option` (
  `no` int(11) NOT NULL AUTO_INCREMENT,
  `it_id` varchar(10) NOT NULL,
  `io_type1` varchar(50) NOT NULL,
  `io_type2` varchar(50) NOT NULL,
  `io_type3` varchar(50) NOT NULL,
  `io_amt` int(11) NOT NULL,
  `io_point` int(11) NOT NULL,
  `io_qty` int(11) NOT NULL,
  `io_qty2` int(11) NOT NULL,
  `io_use` int(11) NOT NULL default '1',
  `reg_date` varchar(50) NOT NULL,
  PRIMARY KEY  (`no`),
  KEY `it_id` (`it_id`),
  KEY `it_id_2` (`it_id`,`io_type1`),
  KEY `it_id_3` (`it_id`,`io_type1`,`io_type2`),
  KEY `it_id_4` (`it_id`,`io_type1`,`io_type2`,`io_type3`),
  KEY `io_type1` (`io_type1`,`io_type2`,`io_type3`)
) ENGINE=MyISAM;
...
DROP TABLE IF EXISTS `yc4_order_md`;


CREATE TABLE IF NOT EXISTS `yc4_order_md` (
  `no` int(11) NOT NULL auto_increment,
  `od_id` varchar(255) NOT NULL,
  `md_name` varchar(255) NOT NULL,
  `md_tel` varchar(255) NOT NULL,
  `md_hp` varchar(255) NOT NULL,
  `md_zip1` varchar(6) NOT NULL,
  `md_addr1` varchar(255) NOT NULL,
  `md_addr2` varchar(255) NOT NULL,
  `md_memo` text NOT NULL,
  `md_qty` text NOT NULL,
  `md_dl_id` int(11) NOT NULL,
  `md_invoice_time` varchar(50) NOT NULL,
  `md_invoice` varchar(255) NOT NULL,
  `reg_date` varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS `yc4_order_md_del`;


CREATE TABLE IF NOT EXISTS `yc4_order_md_del` (
  `no` int(11) NOT NULL,
  `od_id` varchar(255) NOT NULL,
  `md_name` varchar(255) NOT NULL,
  `md_tel` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `yc4_coupon`;


CREATE TABLE IF NOT EXISTS `yc4_coupon` (
  `cpn_id` int(11) NOT NULL auto_increment,
  `cpn_no` varchar(8) NOT NULL,
  `mb_id` varchar(255) NOT NULL,
  `cpn_name` varchar(255) NOT NULL,
  `cpn_type` varchar(2) NOT NULL default 'P' COMMENT 'p:퍼센트. w:고정금액',
  `cpn_amt` int(11) NOT NULL,
  `cpn_start` varchar(20) NOT NULL,
  `cpn_end` varchar(20) NOT NULL,
  `reg_date` varchar(20) NOT NULL,
  `use_date` varchar(20) NOT NULL,
  PRIMARY KEY  (`cpn_id`),
  UNIQUE KEY `cpn_no` (`cpn_no`)
) ENGINE=MyISAM;
