...
먼저 아래 폴더들 권한 변경 하시고 진행해주세요!

public_html  - 폴더 707 (하위 디렉터리 체크 X)
public_html/data  - 폴더 707 (하위 디렉터리 체크 O)
public_html/shop/kcp/log - 폴더 707 (하위 디렉터리 체크 X)
public_html/shop/kcp/bin/pp_cli - 파일 707 (하위 디렉터리 체크 X)
</textarea> 
