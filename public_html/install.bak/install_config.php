            ...
            <td><strong>최고관리자 정보입력</strong> <br>
              ...
              <table width="270" border="0" cellpadding="0" cellspacing="0" class="body">
                <tr> 
                  ...
                  <td><input name="admin_id" type="text" class="box" value="itmaster" onkeypress="only_alpha();"></td>
                </tr>
                <tr> 
                  <td width="80" align="right" height=30>Password :&nbsp;</td>
                ...
                <tr> 
                  ...
                  <td><input name="admin_email" type="text" class="box" value="admin@it9.co.kr"></td>
                </tr>
              </table> </td>
          </tr>
        </table>
