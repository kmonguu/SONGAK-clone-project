...
$ninetalk_addon_loadurl = "http://{$chat_server}/app_alimi/chat/admin_chatting.php?protocol={$protocol}&chat_id={$chat_id}&chat_port={$chat_port}&room_no={$room_no}&chat_server={$chat_server}";
