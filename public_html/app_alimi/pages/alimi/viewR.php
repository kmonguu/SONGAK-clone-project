...
<div id="m_view">
	...
	<ul style='line-height:2;margin-left:-10px'>
		...
		<?}?>
		<li><strong>이름</strong> <span style="float:right;width:70%"><?=$view[wr_name]?></span></li>
		<li><strong>핸드폰</strong> <span style="float:right;width:70%"><a href="tel:<?=$view[wr_1]?>"><?=$view[wr_1]?></a></span></li>
		<li><strong>객실선택</strong> <span style="float:right;width:70%"><?=$view[wr_7]?></span></li>
		<li><strong>숙박기간</strong> <span style="float:right;width:70%"><?=$view[wr_3]?> <?=$view[wr_2]?></span></li>
		<li><strong>인원수</strong> <span style="float:right;width:70%"> 성인: <?=$view[wr_5]?>명 소인: <?=$view[wr_6]?>명</span></li>
	</ul>
