...
<div id="m_cmt_list" style='margin-bottom:5px'>
	<ul>
	<?
	...
	?>
		<li> 
			<div class="cmt_hd">
				...
				<a href="javascript:comment_delete('./pages/alimi/delete_comment.php?bo_table=<?=$bo_table?>&comment_id=<?=$list[wr_id]?>&cwin=&page=0&page=0');" data-ajax="false">삭제</a>
			</div>
			<div class="line"></div>
...
<?}?>
<?if($is_admin){?>
<form name="fviewcomment" method="post" onsubmit="return fviewcomment_submit(this);" autocomplete="off" style="margin:0px;" data-ajax="false">
...
<div id="m_cmt_write" style='margin:0 0 0 0'>
	<ul>
	<li style='padding-bottom:0px'>
		<textarea id="wr_content" name="wr_content" rows="4" itemname="내용" required="required" placeholder="내용" onFocus="this.placeholder=''" style='height:30px'></textarea>
	</li>
...
function fviewcomment_submit(f) {
	...
	loading();
    f.action='./pages/bbs/write_comment_update.php';
