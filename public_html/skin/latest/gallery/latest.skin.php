...
<style>
	...
	.swiper_m3 { position:relative; width:1544px; height:405px; padding-top:45px; float:right; padding-bottom:140px;}
	...
	.swiper_m3 .swiper-slide:hover .slide_img { box-shadow:5px 10px 10px 0px rgba(0,0,0,.3); transform:scale(0.925); }
