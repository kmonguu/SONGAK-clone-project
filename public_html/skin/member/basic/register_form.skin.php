            ...
            <TD valign="middle" class=m_padding>
                ...
                <tr>
                    <td height="25"><input class=ed type=text name='mb_zip1' size=4 maxlength=3 readonly <?=$config[cf_req_addr]?'required':'';?> itemname='우편번호 앞자리' value='<?=$member[mb_zip1]?>'>
                        ...
                        &nbsp;<a href="javascript:;" onclick="openDaumPostcode('fregisterform', 'mb_addr1', 'mb_addr2', '', 'mb_zip1', 'mb_zip2', '');"><img width="91" height="20" src="<?=$member_skin_path?>/img/post_search_btn.gif" border=0 align=absmiddle></a></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td height="25" colspan="2"><input class=ed type=text name='mb_addr2' size=60 itemname='상세주소' value='<?=$member[mb_addr2]?>'></td>
                </tr>
                </table>
            </TD>
        </TR>
