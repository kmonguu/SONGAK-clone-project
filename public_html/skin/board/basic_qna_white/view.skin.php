		...
		<table cellpadding="0" cellspacing="0" border="0" style="width:100%;" >
			<tr>
				...
				<td style="padding:3px 0 0 0">
					<a href="/shop/item.php?it_id=<?=$view[wr_6]?>#qnalist">
				...
				<td style="padding:0 0 0px 0px;width:100%;">
					<style>
						...
						.request th,
						.request td { padding:8px 10px; border-bottom:1px solid #dddddd;line-height:15px;font-size:13px;  }
						.request th { text-align:left; color:#676767;font-weight:bold; font-size:13px; background:#f3f3f3;line-height:15px;  }
						.request td { color:#444444; }
					</style>
					<table class="request" cellspacing="0" width=100% style="width:100%;" >
						<colgroup>
							<col width="70px" >
							<col width="" >
						</colgroup>
...
<?
// 코멘트 입출력 *상품질문은 코멘트말고 답글로 유도하기위해서 없앰
...
<div style="clear:both; height:30px;display:none">
    ...
    ?>
	<?if($is_has){?>
	<? echo "<a href=\"/shop/item.php?it_id={$view[wr_6]}#qnalist\"><span class='nBtn1'>&lt;&lt;&nbsp;상품으로</span></a> "; ?>
	<?}?>
