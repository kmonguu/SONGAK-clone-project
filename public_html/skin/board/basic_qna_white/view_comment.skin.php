...
<style>
#comment_title { width:100%; display:inline-block; text-align:left; height:40px; line-height:40px; }
#comment_title > p { line-height:40px; color:#272727; font-size:18px; font-weight:300; padding-left:22px; background:url("/img/comment_icon.png") no-repeat left center; }
...
.comment_write_top > span { color:#272727; font-size:18px; font-weight:300; }
#answer1 { display:inline-block; float:right; background:#e9e9e9; color:#4c4c4c; font-size:15px; padding:0 22px; cursor:pointer; }
#answer2 { display:inline-block; float:right; background:#e9e9e9; color:#4c4c4c; font-size:15px; padding:0 22px; margin:0 5px; cursor:pointer; }
#fviewcomment_submit_btn { display:inline-block; float:right; background:#ff9c00; color:#fff; font-size:17px; padding:0 22px; line-height:35px; border:0; cursor:pointer; font-weight:300; }
...
.comment_con_head { display:inline-block; width:100%; padding:0 20px; box-sizing:border-box; line-height:31px; color:#777; font-size:15px; font-weight:300; border-bottom:1px solid #ddd; }

.comment_content { width:100%; min-height:130px; color:#272727; font-size:15px; font-weight:300; border:0px; padding:10px 20px; box-sizing:border-box; background:none !important; margin:0; resize:none; }

a.comment_link { display:inline-block; padding-left:20px; line-height:16px; color:#777; font-size:15px; font-weight:300; text-decoration:none; }
						...
						<tbody>
							<tr>
								<td valign="top" align="center" >
									...
									<p style="font-size:14px; color:#222; font-weight:300; padding:5px 0 0;">
									...
									<? if ($is_ip_view) {?>
										<p style="font-size:14px; color:#666; font-weight:300; padding:5px 0 0;">IP : <?=$list[$i][ip]?></p>
									<? } ?>
								</td>
								<td valign=top align="left" style="padding:0 20px 0 80px;" >
									...
									<!-- 코멘트 출력 -->
									<p class="hidden" >내용 : </p>
									<div style='font-size:17px; color:#222; font-weight:300; line-height:24px; '>
										<?
								...
								<td valign="bottom" align="center" >
									<? if ($list[$i][is_reply]) { echo "<div style='padding:3px 0;' ><a href=\"#comment_box\" onclick=\"comment_box('{$comment_id}', 'c');\" class='comment_link comment_link1' >답변</a></div> "; } ?>
									<? if ($list[$i][is_edit]) { echo "<div style='padding:3px 0;' ><a href=\"#comment_box\" onclick=\"comment_box('{$comment_id}', 'cu');\" class='comment_link comment_link2' >수정</a></div> "; } ?>
									<? if ($list[$i][is_del])  { echo "<div style='padding:3px 0;' ><a href=\"#comment_box\" onclick=\"comment_delete('{$list[$i][del_link]}');\" class='comment_link comment_link3' >삭제</a></div> "; } ?>
								</td>
							</tr>
						</tbody>
					</table>
