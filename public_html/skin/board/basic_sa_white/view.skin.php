...
<div style="clear:both; height:30px;display:none">
    ...
    ob_start();
    ?>
	<? echo "<a href=\"/shop/item.php?it_id={$view[wr_6]}#afterlist\"><span class='nBtn1'>&lt;&lt;&nbsp;상품으로</span></a> "; ?>
		...
		<table cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td style="padding:3px 0 0 0">
					<a href="/shop/item.php?it_id=<?=$view[wr_6]?>#afterlist">
						<?=get_it_image2($it[it_id], '_m','140px','140px');?>
					</a>
				</td>
